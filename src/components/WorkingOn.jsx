  ...
  return (
    <div className='py-16 bg-white h-[620px]'>
      ...
      <div className='max-w-[1240px] mx-auto grid gap-16 lg:grid-cols-3 mb-16'>
        <a href='https://www.website.com' className='bg-[#eae7dc] p-6 rounded-lg shadow-md hover:scale-105 transition duration-300'>
        ...
        <a href='https://www.app.com' className='bg-[#eae7dc] p-6 rounded-lg shadow-md hover:scale-105 transition duration-300'>
        ...
        <a href='https://www.game.com' className='bg-[#eae7dc] p-6 rounded-lg shadow-md hover:scale-105 transition duration-300'>
